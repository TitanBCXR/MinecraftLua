...
return {
  ...
  launcher = {
    files = {
      ...
      "lib/titan.lua", "lib/casino.lua", "lib/games_economy.lua",
  ...
  games = {
    ...
    },
    {
      ...
      files = { "lib/games_music.lua", "lib/pocket_peripherals.lua", "luigi_poker.lua", "lib/casino.lua", "lib/games_economy.lua" },
    },
    {
      id = "higher_lower",
      ...
      files = { "lib/games_music.lua", "lib/pocket_peripherals.lua", "higher_lower.lua", "lib/casino.lua", "lib/games_economy.lua" },
    },
    {
      id = "slots",
      name = "Slots",
      run = "slots.lua",
      desc = "3-reel slots",
      files = { "lib/games_music.lua", "lib/pocket_peripherals.lua", "slots.lua", "lib/casino.lua", "lib/games_economy.lua" },
    },
  },
}
