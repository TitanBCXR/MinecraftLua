...
return {
  ...
  packages = {
    ...
    ["storage/managers/storage_manager.lua"] = "1.3.1",
    ["storage/workers/storage_builder.lua"] = "1.0.0",
    ["storage/managers/storage_atm.lua"] = "1.4.0",
    ["storage/managers/storage_clutch.lua"] = "1.8.11",
    ["storage_manager.lua"] = "1.3.1",
    ["storage/workers/factory_clutch.lua"] = "1.2.0",
    ["factory_clutch.lua"] = "1.2.0",
    ["storage/managers/factory_admin.lua"] = "1.0.1",
    ["factory_admin.lua"] = "1.0.1",
    ["storage_builder.lua"] = "1.0.0",
    ["storage_atm.lua"] = "1.4.0",
    ["storage_clutch.lua"] = "1.8.11",
