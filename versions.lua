...
return {
  ...
  packages = {
    ...
    ["games/managers/currency_manager.lua"] = "1.0.0",
    ["currency_manager.lua"] = "1.0.0",
    ["perimeter_sensor.lua"] = "1.2.8",
    ["perimeter_manager.lua"]= "1.3.8",
    ["tetris.lua"]         = "1.2.8",
    ["minesweeper.lua"]    = "1.2.3",
    ["sandstorm.lua"]      = "1.0.1",
    ["luigi_poker.lua"]    = "1.2.4",
    ["higher_lower.lua"]   = "1.0.3",
    ["slots.lua"]          = "1.0.3",
    ["games.lua"]          = "1.0.7",
    ["games_catalog.lua"]  = "1.0.5",
