...
return {
  ...
  packages = {
    ...
    ["storage/managers/storage_manager.lua"] = "1.3.2",
    ...
    ["storage_manager.lua"] = "1.3.2",
    ["storage/workers/factory_clutch.lua"] = "1.2.0",
    ["factory_clutch.lua"] = "1.2.0",
    ["storage/managers/factory_admin.lua"] = "1.0.2",
    ["factory_admin.lua"] = "1.0.2",
